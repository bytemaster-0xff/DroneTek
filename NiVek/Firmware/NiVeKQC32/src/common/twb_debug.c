...
iOpResult_e TWB_Debug_PrintInt(const char *strBuffer, int32_t value) {
...
iOpResult_e TWB_Debug_Print2Int(const char *strBuffer, int32_t value1, int32_t value2) {
	TWB_Debug_Print(strBuffer);
