...
iOpResult_e __ms5611_processTemperature(void) {
	...
	__ms5611_temperature = (2000 + (__ms5611_deltaTemperature * (__ms5611Calib->c6 * 1.19209e-07f))) / 100.0f;
