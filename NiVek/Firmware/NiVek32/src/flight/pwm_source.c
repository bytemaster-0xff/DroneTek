...
#define PWM_MinDutyCycle 			PWM_Period / 20 //1ms
#define PWM_MaxDutyCycle 			PWM_Period / 10 //2ms
...
void TWB_PWM_ManagePower() {
	...
	if(__escLeftTargetPower != MotorStatus->ESC_Left){
		if(__escLeftTargetPower < MotorStatus->ESC_Left)
			dutyCycle = ((PWM_RANGE_INT_MATH_NUMERATOR * (uint16_t)--MotorStatus->ESC_Left) / PWM_RANGE_INT_MATH_DENOMENATOR) + PWM_MinDutyCycle;
	...
	if(__escRearTargetPower != MotorStatus->ESC_Rear){
		if(__escRearTargetPower < MotorStatus->ESC_Rear)
			dutyCycle = ((PWM_RANGE_INT_MATH_NUMERATOR * (uint16_t)--MotorStatus->ESC_Rear) /PWM_RANGE_INT_MATH_DENOMENATOR) + PWM_MinDutyCycle;
	...
	if(__escFrontTargetPower != MotorStatus->ESC_Front){
		if(__escFrontTargetPower < MotorStatus->ESC_Front)
			dutyCycle = ((PWM_RANGE_INT_MATH_NUMERATOR * (uint16_t)--MotorStatus->ESC_Front) / PWM_RANGE_INT_MATH_DENOMENATOR) + PWM_MinDutyCycle;
	...
	if(__escRightTargetPower != MotorStatus->ESC_Right){
		if(__escRightTargetPower < MotorStatus->ESC_Right)
			dutyCycle = ((PWM_RANGE_INT_MATH_NUMERATOR * (uint16_t)--MotorStatus->ESC_Right) / PWM_RANGE_INT_MATH_DENOMENATOR) + PWM_MinDutyCycle;
