...
typedef struct _Device_TypeDef
{
  ...
  uint8_t  *(*GetInterfaceStrDescriptor)( uint8_t speed , uint16_t *length, uint8_t intIdx);
  ...
  uint8_t  *(*GetExtPropertiesFeatureDescriptor)( uint8_t speed , uint16_t *length, uint8_t intIdx);
