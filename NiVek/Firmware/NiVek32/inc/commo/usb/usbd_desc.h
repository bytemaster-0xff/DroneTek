...
uint8_t *     USBD_USR_InterfaceStrDescriptor( uint8_t speed , uint16_t *length, uint8_t idxInt);
uint8_t *     USBD_USR_OSStrDescriptor( uint8_t speed , uint16_t *length);
uint8_t *     USBD_USR_ExtPropertiesFeatureDescriptor( uint8_t speed , uint16_t *length, uint8_t idxInt);
