...
/**
  ...
  */
    ...
    //RSW - Added these, from another project...
/** @addtogroup STM32F4_DISCOVERY_LOW_LEVEL_USART
  * @{
  */
#define DISCOVERY_COM                USART3
#define DISCOVERY_COM_CLK            RCC_APB1Periph_USART3
#define DISCOVERY_COM_TX_PIN         GPIO_Pin_2 // PA.2
#define DISCOVERY_COM_TX_GPIO_PORT   GPIOA
#define DISCOVERY_COM_TX_GPIO_CLK    RCC_AHB1Periph_GPIOA
#define DISCOVERY_COM_TX_SOURCE      GPIO_PinSource2
#define DISCOVERY_COM_TX_AF          GPIO_AF_USART2
#define DISCOVERY_COM_RX_PIN         GPIO_Pin_3	// PA.3
#define DISCOVERY_COM_RX_GPIO_PORT   GPIOA
#define DISCOVERY_COM_RX_GPIO_CLK    RCC_AHB1Periph_GPIOA
#define DISCOVERY_COM_RX_SOURCE      GPIO_PinSource3
#define DISCOVERY_COM_RX_AF          GPIO_AF_USART3
#define DISCOVERY_COM_IRQn           USART3_IRQn
#define DISCOVERY_COM_IRQHandler     USART3_IRQHandler
