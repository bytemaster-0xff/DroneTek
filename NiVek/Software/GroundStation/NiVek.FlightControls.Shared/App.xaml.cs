...
using NiVek.FlightControls.Inputs;
...
namespace NiVek.FlightControls
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            //if (Windows.Storage.ApplicationData.Current.LocalSettings.Values.ContainsKey("isAdHoc"))
            //    Windows.Storage.ApplicationData.Current.LocalSettings.Values["isAdHoc"] = App.Commo.IsAdhoc;
            //else
            //    Windows.Storage.ApplicationData.Current.LocalSettings.Values.Add("isAdHoc",App.Commo.IsAdhoc);
