...
namespace NiVek.FlightControls
{
    ...
    public sealed partial class Launcher : Page
    {
        ...
        {
            await DroneHub.Instance.RemoveCurrent();
        }
        ...
        private async void Connect_Click(object sender, RoutedEventArgs e)
        {
            if (DroneHub.Instance.Active.CurrentComms.ProtocolType == (Byte)DroneComms.ProtocolTypes.UDP)
            {
                ...
                await udpChannel.ConnectAsync(DroneHub.Instance.Active.CurrentComms.Address, DroneHub.Instance.Active.CurrentComms.Port);
            ...
            else if (DroneHub.Instance.Active.CurrentComms.ProtocolType == (Byte)DroneComms.ProtocolTypes.TCP)
            {
                ...
                await tcpChannel.ConnectAsync(DroneHub.Instance.Active.CurrentComms.Address, DroneHub.Instance.Active.CurrentComms.Port);
