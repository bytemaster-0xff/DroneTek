...
using NiVek.FlightControls.Controls;
...
namespace NiVek.FlightControls.Views
{
    ...
    {
        public NiVekHeader HeaderItem { get; set; }
        ...
        protected virtual void GamePadChanged(NiVek.GroundStation.GamePad.ButtonStateChangedEventArgs gamePadState)
        {
