...
namespace NiVek.Common.Modules
{
    public class SensorModule
    {
        ...
        public const int CMD_BeginMagCalibrationXY = 0xA0;
        public const int CMD_BeginMagCalibrationZ = 0xA1;
        public const int CMD_CancelMagCalibration = 0xA2;
        public const int CMD_EndMagCalibration = 0xA3;
