...
{
    public class ConfigBase : ModelBase
    {
        ...
        protected const ushort SONAR_EEPROM_OFFSET = 0x01E0;
        ...
        protected const ushort MS5611_EEPROM_OFFSET = 0x0380;
        ...
        ObservableCollection<SensorDefinition> _allSensors = new ObservableCollection<SensorDefinition>()
            {
                ...
                new SensorDefinition() { Display ="AltMSC5611", Value=Sensors.MS5611,SensorType = SensorDefinition.SensorTypes.Altitude },
