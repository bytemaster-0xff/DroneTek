...
namespace NiVek.Common.Comms
{
    ...
    public class Drone : ModelBase
    {
        ...
        public Drone()
        {
            ...
            _timer = ServiceLocator.Current.GetInstance<ITimerManager>().CreateTimer(TimeSpan.FromSeconds(0.25));
        }
...
//            Config = await GetAsync<GPIOConfig>(Common.ModuleTypes.GPIO, Modules.GPIOModule.CMD_ReadAllPIDConstants, IncomingMessage.GPIOPidConstants);
        ...
        public void StartPingTimer()
        {
            if (_timer == null)
            {
                _timer = ServiceLocator.Current.GetInstance<ITimerManager>().CreateTimer(TimeSpan.FromSeconds(0.1250));
        ...
        public async void SendName()
        {
            ...
            msg.ExpectACK = true;
            msg.ModuleType = NiVek.Common.Comms.Common.ModuleTypes.System;
            msg.MessageId = NivekSystem.SetName;
        ...
        public GalaSoft.MvvmLight.Command.RelayCommand ArmCommand
        {
            get { return new GalaSoft.MvvmLight.Command.RelayCommand(() => ArmButtonClick()); }
        }
